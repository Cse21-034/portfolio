...
const projects = [
  ...
  },
  {
    ...
    description:
      "Comprehensive ICT solutions including network infrastructure, cybersecurity, smart metering, and telecommunications for businesses across Botswana and beyond.",
  ...
  },
  {
    ...
    description:
      "Sustainable design. Integrated management. Premium property solutions for the modern era.",
  ...
  // ── LOADX AFRICA ───────────────────────────────────────────────────────────
  {
    ...
    description:
      "Connect trucking companies and shipping entities across Africa. Real-time job matching, secure payments, and AI-powered logistics solutions for the China-Botswana freight corridor. Features freight listings, carrier profiles, and real-time tracking.",
  ...
  // ── FREELANCER ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Full-stack shop with authentication, shopping cart, secure checkout, admin dashboard, and separated frontend/backend architecture for scalable deployment.",
  ...
  },
  {
    ...
    description:
      "Responsive portfolio site with dark mode toggle, smooth animations, contact form, project showcase, and modern design principles.",
    image:
  ...
  },
  {
    ...
    description:
      "Agricultural services platform featuring farm products, borehole services, image gallery, contact management, and content management system.",
...
export function Projects() {
  ...
  const filteredProjects = projects.filter((project) => {
    const matchesOrg =
      activeOrg === "all" || project.organization === activeOrg;
    const matchesSearch =
      searchTerm === "" ||
  ...
  const getProjectIcon = (project) => {
    if (project.organization === "orange")
      return <Microscope className="mr-1 h-4 w-4 text-orange-500" />;
    ...
    if (project.organization === "loadxafrica")
      return <Truck className="mr-1 h-4 w-4 text-blue-500" />;
    return <ExternalLink className="mr-1 h-4 w-4" />;
  };

  const getOrgCountForId = (orgId) =>
    orgId === "all"
      ? projects.length
      : projects.filter((p) => p.organization === orgId).length;

  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Work delivered across organizations — from AI-powered healthcare
            tools to logistics platforms and freelance solutions.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          ...
          >
            <span
              className="inline-flex items-center justify-center rounded-md bg-[#ff6600] shrink-0"
          ...
          >
            <span
              className="inline-flex items-center justify-center rounded-md bg-emerald-500 text-white font-black shrink-0"
          ...
          >
            <span
              className="inline-flex items-center justify-center rounded-md bg-blue-600 text-white font-black shrink-0"
              style={{ width: 20, height: 20, fontSize: 8, letterSpacing: "-0.5px" }}
            >
              LX
            </span>
            <span
          ...
          >
            <span
              className="inline-flex items-center justify-center rounded-md bg-[#29B2FE] shrink-0 overflow-hidden"
              style={{ width: 20, height: 20 }}
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML =
                    '<span style="color:white;font-weight:900;font-size:10px">f</span>';
                }}
              />
            </span>
            <span
              ...
              >
                {project.organization === "orange" && (
                  <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-semibold px-4 py-2 text-center flex items-center justify-center gap-2">
                    <span className="inline-flex items-center justify-center rounded bg-white/25 px-1.5 py-0.5 text-white font-black text-xs tracking-tight">
                      ODC
                    </span>
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 flex flex-col gap-1 items-end">
                    <span
                      className={`text-xs px-2 py-1 rounded-full font-semibold border ${meta.bg} ${meta.color} ${meta.border}`}
                    >
                      {meta.badge}
                    </span>
                    {project.year && (
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <Badge
                        key={tech}
                        className={`${getTechBadgeColor(tech)} text-xs px-2 py-1 font-medium`}
                      >
                        {tech}
                      </Badge>
                    ))}
          ...
          <div className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-cyan-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-2xl p-8 sm:p-12 max-w-4xl mx-auto overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                ...
                ideas to life. Whether you have a project in mind or want to
                discuss potential opportunities, I'd love to hear from you.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  className="px-8 py-4 rounded-full transition-all duration-200 transform hover:scale-105"
                >
