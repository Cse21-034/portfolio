      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Recent graduate passionate about technology, cybersecurity, and creating innovative solutions that make a real impact.
          </p>
        </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="mb-6">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 text-blue-800 dark:text-blue-300 px-4 py-2 rounded-full border border-blue-200 dark:border-blue-700 mb-4">
                ...
                <span className="text-sm font-semibold">Fresh Graduate</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                Software Engineering Graduate & Tech Professional
              </h3>
            </div>
            
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              <p>
                I recently graduated with a BSc (Hons) in Computer Systems & Software Engineering, 
                marking the culmination of years of dedicated study and hands-on experience in 
                software development and cybersecurity.
              </p>
              
              <p>
                Based in Molepolole, Botswana, I've built a solid foundation combining academic 
                knowledge with practical experience across 13+ projects spanning web development, 
                mobile applications, and cybersecurity solutions. My work demonstrates proficiency 
                in modern technologies and a commitment to creating secure, scalable solutions.
              </p>
              
              <p>
                As a recent graduate entering the professional world, I'm excited to apply my 
                technical skills to solve complex real-world problems while continuing to learn 
                and grow in the rapidly evolving tech landscape.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-700">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">Recently Graduated</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200 dark:border-green-700">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-green-600 dark:text-green-400 mt-1">Open to Remote</p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-700">
            <CardContent className="p-6 text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Fresh Perspective</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Bringing modern approaches and the latest industry knowledge to every project
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-orange-200 dark:border-orange-700">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Eager to apply academic knowledge and practical skills in professional environments
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900/20 dark:to-cyan-800/20 border-cyan-200 dark:border-cyan-700">
            <CardContent className="p-6 text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Continuous Learner</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
